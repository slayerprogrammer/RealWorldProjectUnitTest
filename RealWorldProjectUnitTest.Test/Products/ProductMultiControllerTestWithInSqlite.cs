...
{
    public class ProductMultiControllerTestWithInSqlite : ProductMultiControllerBase
    {
        public ProductMultiControllerTestWithInSqlite()
        {
            //memory de tutulması için yazıyoruz.
            var connection = new SqliteConnection("DataSource=:memory:");
            connection.Open();

            SetContextOptions(new DbContextOptionsBuilder<RealWorldProjectContext>().UseSqlite(connection).Options);
        }
